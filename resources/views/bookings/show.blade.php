    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                @if($booking->status === 'Pending' && optional($booking->payment)->payment_method === 'Stripe' && optional($booking->payment)->payment_status !== 'Paid')
                    <form method="POST" action="{{ route('stripe.checkout', $booking) }}">
                        @csrf
