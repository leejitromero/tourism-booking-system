    ...
    <div class="col-lg-7">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select form-select-lg" name="payment_method"><option>Cash</option><option>GCash</option><option>Bank Transfer</option></select>
            </div>
            <div class="col-12"><label class="form-label fw-semibold">Reference Number</label><input class="form-control" name="reference_number" value="{{ old('reference_number') }}" placeholder="Optional for GCash/Bank Transfer"></div>
